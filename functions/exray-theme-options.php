...
function exray_theme_select_callback(){
	...
	$html = '<select name="exray_theme_input_options[select_element]" id="select_element">';
		...
		$html .= '<option value="never" '. selected( isset($options['select_element']) ? $options['select_element']  : 0 , false).' >Never</option>';
		$html .= '<option value="sometimes" '. selected( isset($options['select_element']) ? $options['select_element'] : 0, false ) .' >Sometimes</option>';
		$html .= '<option value="always" '. selected( isset($options['select_element']) ? $options['select_element'] : 0, false ) .' >Always</option>';
	$html .= '</select>';
